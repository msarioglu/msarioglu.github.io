...
include-npm-deps:
	...
	cp node_modules/particles.js/particles.js $(VENDOR_DIR)
	cp node_modules/particles.js/demo/js/app.js $(VENDOR_DIR)
	cp node_modules/@fortawesome/fontawesome-free/webfonts/*.* $(FONTS_DIR)
